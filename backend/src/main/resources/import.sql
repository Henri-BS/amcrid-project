...
INSERT INTO tb_quiz ( title, description, image, chapter_id) VALUES ( 'A Produção no Desenvolvimento de Jogos', 'Quiz sobre a fase de produção no desenvolvimento de jogos', 'https://img.wonderhowto.com/img/20/66/63724953674051/0/expand-your-coding-skill-set-by-learning-build-games-unity.w1456.jpg', 1);
